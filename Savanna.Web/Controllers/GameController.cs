...
public class GameController : Controller
{
    ...
    public async Task<IActionResult> SaveGame()
    {
        ...
        //{
        //    Id = _gameSetup.GameField.Id,
        //    UserId = userId,
        //    Name = $"{userId}_{_gameSetup.GameField.Id}_{DateTime.Now:yyyyMMddHHmmss}",
        //    GameState = _gameService.GetGameField(),
        //    GameIteration = _gameSetup.GameField.GameIteration,
        //    Animals = _gameSetup.GetAnimals().Select(a => new AnimalEntity
        //    {
        //        AnimalId = a.Id,
        //        Species = a.GetType().Name,
        //        Age = a.Age,
        //        Health = a.Health,
        //        Offspring = a.Offspring,
        //        GameId = _gameSetup.GameField.Id
        //    }).ToList()
        //};
    ...
    public async Task<IActionResult> LoadGame()
    {
        ...
        List<GameStatsViewModel> savedGames = savedGamesEntities.Select(gameEntity => new GameStatsViewModel
        {
